...
import ReturningPatientForm1 from './ReturningPatientForm1';
...
function ReturningPatientSwitchForm() {
    ...
    switch (step.id) {
        case "patient":
            return <ReturningPatientForm1 {...personalProps}/>
    }
...
export default ReturningPatientSwitchForm